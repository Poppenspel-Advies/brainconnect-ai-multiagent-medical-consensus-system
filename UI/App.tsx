...
export default function BrainConnectApp() {
  ...
  const handleUpload = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!data.summary || !data.diagnosis || !data.treatment) {
            ...
            <div className="mt-16 space-y-12">
              <div className="grid gap-6 lg:grid-cols-3">
                <div className="bg-[#0A2540] p-8 rounded-3xl border border-blue-500/50">
                  <div className="text-blue-400 text-sm font-medium tracking-widest mb-2">SUMMARY</div>
                  <div className="text-gray-300 leading-relaxed">{analysis.summary}</div>
                </div>
                <div className="bg-[#0A2540] p-8 rounded-3xl border border-white/10 hover:border-white/30">
                  ...
                  <div className="text-gray-300 leading-relaxed">{analysis.diagnosis}</div>
                </div>
                <div className="bg-[#0A2540] p-8 rounded-3xl border border-white/10 hover:border-white/30">
                  <div className="text-emerald-400 text-sm font-medium tracking-widest mb-2">TREATMENT PLAN</div>
                  <div className="text-gray-300 leading-relaxed">{analysis.treatment}</div>
                </div>
              </div>
